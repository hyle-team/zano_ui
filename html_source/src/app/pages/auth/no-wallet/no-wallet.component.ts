...
@Component({
  ...
  template: `
    <div class="no-wallet-wrapper" fxFlexFill fxLayout="row" fxLayoutAlign="center center">
      <div class="card max-w-42-rem max-h-100 w-100 p-2 border-radius-0_8-rem bg-light-blue scrolled-content">
        ...
        <button [routerLink]="['/' + paths.create]" class="primary big w-100 mb-1" type="button">
        ...
        <button [routerLink]="['/' + paths.restore]" class="outline big w-100 mb-2" type="button">
